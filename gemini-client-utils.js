 ...
 * @param {string} model - The Gemini model to use (default: gemini-1.5-flash)
 * @returns {Promise<object>} The AI response
 */
async function callGeminiAPI(prompt, systemInstruction = null, model = 'gemini-1.5-flash') {
  try {
...
async function example2() {
  const systemInstruction = 'You are a helpful quiz assistant. Generate questions in a clear, educational manner.';
