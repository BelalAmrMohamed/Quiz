// scripts/generatequiz-manifest.js
// The next line runs this file which generates ./src/scripts/quiz-manifest.js
// >  node scripts/generatequiz-manifest.js
    ...
    for (const entry of entries) {
      ...
      if (entry.isDirectory()) {
        ...
        if (depth >= 3 && metadata.currentKey) {
          ...
          // Calculate relative path from src/scripts/ directory
...
async function generate() {
  ...
  // Write output file
  const outFile = path.join(scriptDir, "quiz-manifest.js");
  const header = `// src/scripts/quiz-manifest.js\n// Auto-generated by ./scripts/generatequiz-manifest.js - do not edit by hand\n// Run: node scripts/generatequiz-manifest.js\n// Last generated at: ${formatDateTime()}\n\n`;
  const body =
