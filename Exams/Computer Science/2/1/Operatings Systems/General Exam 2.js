export const questions = [
  {
    ...
    options: ["The Bootstrap Program", "The Kernel", "The Shell", " The GUI"],
    correct: 1,
    explanation:
      "The kernel is the one program running at all times on the computer. All other components are considered system or application programs[cite: 374].",
  },
  {
    ...
    correct: 0,
    explanation:
      "The distinction between kernel mode and user mode provides a rudimentary form of protection, ensuring privileged instructions and hardware access are restricted to the kernel[cite: 377].",
  },
  {
    q: "Which mechanism allows user-level processes to request services from the operating system?",
    options: ["Interrupts", "Context Switching", "System Calls", "Threading"],
    correct: 2,
    explanation:
      "System calls provide the interface for user-level processes to request services from the operating system[cite: 175].",
  },
  {
    ...
    correct: 2,
    explanation:
      "The fork system call clones the currently executing process to create a new one[cite: 213].",
  },
  {
    ...
    correct: 0,
    explanation:
      "Context switching involves saving the CPU registers of the thread/process being switched out and restoring the registers of the new one[cite: 151].",
  },
  {
    ...
    correct: 0,
    explanation:
      "The Process Control Block (PCB) is a data structure allocated to hold specific information for a process, including the memory map and register set[cite: 158].",
  },
  {
    ...
    correct: 3,
    explanation:
      "Threads share the address space (code and data) and resources like open files, but they maintain their own registers and stack[cite: 161].",
  },
  {
    ...
    correct: 1,
    explanation:
      "False.  Kernel threads are generally more expensive to maintain than user threads because they must be represented with a kernel data structure[cite: 148].",
  },
  {
    ...
    correct: 1,
    explanation:
      "Amdahl's law illustrates that performance gains are limited by the serial portion of an application, even as the number of processing cores increases[cite: 137].",
  },
  {
    ...
    correct: 0,
    explanation:
      "The convoy effect is described as short processes waiting behind a long process, typically seen in First-Come, First-Served (FCFS) scheduling[cite: 113].",
  },
  {
    ...
    correct: 2,
    explanation:
      "SJF is optimal because it gives the minimum average waiting time for a given set of processes[cite: 114].",
  },
  {
    ...
    correct: 1,
    explanation:
      "If the time quantum (q) is large, the Round Robin algorithm effectively becomes a First-Come, First-Served (FIFO/FCFS) algorithm[cite: 128].",
  },
  {
    ...
    correct: 2,
    explanation:
      "Starvation is the problem where low priority processes may never execute[cite: 122].",
  },
  {
    ...
    correct: 0,
    explanation:
      "Aging is the solution to starvation; it involves gradually increasing the priority of a process as it waits in the system[cite: 122].",
  },
  {
    ...
    correct: 0,
    explanation:
      "Preemptive SJF (Shortest-Remaining-Time-First) will preempt the current process if a newly arriving process has a shorter predicted CPU burst[cite: 116].",
  },
  {
    ...
    correct: 0,
    explanation:
      "The three activities are tracking memory usage, deciding loading order, and allocating/deallocating space[cite: 189].",
  },
  {
    ...
    correct: 1,
    explanation:
      "Throughput is defined as the number of processes that complete their execution per time unit[cite: 90].",
  },
  {
    ...
    correct: 0,
    explanation:
      "The bootstrap program runs at startup, stored in firmware, and is responsible for determining which operating system to boot into and loading it[cite: 258].",
  },
  {
    ...
    correct: 1,
    explanation:
      "A microkernel structure moves as much as possible from the kernel into user space[cite: 209]. Note: While text specifically discusses shell/interpreters being separate, the general concept of Microkernels (implied in standard OS curricula) moves services to user space to keep the kernel small.",
  },
  {
    ...
    correct: 0,
    explanation:
      "Preemptive scheduling allows interruption of a running process, while nonpreemptive requires the process to voluntarily relinquish control[cite: 276].",
  },
];
