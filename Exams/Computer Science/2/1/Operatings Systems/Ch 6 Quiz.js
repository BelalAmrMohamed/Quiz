export const questions = [
  {
    ...
    correct: 1,
    explanation:
      "The goal is to keep the CPU as busy as possible to get the most work done.",
  },
  {
    ...
    correct: 2,
    explanation:
      "Processes alternate between performing calculations (CPU burst) and waiting for input/output (I/O burst).",
  },
  {
    q: "The short-term scheduler selects processes from:",
    options: ["Job queue", "Ready queue", "Device queue", "Termination queue"],
    correct: 1,
    explanation:
      "The ready queue holds all processes that are prepared and waiting to execute on the CPU.",
  },
  {
    ...
    correct: 2,
    explanation:
      "Nonpreemptive means the process keeps the CPU until it either terminates or switches to a waiting state (like for I/O).",
  },
  {
  ...
  },
  {
    ...
    correct: 2,
    explanation:
      "This is the overhead time taken by the dispatcher to stop one process and start the next one.",
  },
  {
  ...
  },
  {
    ...
    correct: 1,
    explanation:
      "It measures the total time a process takes from start to finish.",
  },
  {
    ...
    correct: 1,
    explanation:
      "Like a slow truck leading a line of fast cars, short processes get stuck behind one very long process.",
  },
  {
    ...
    correct: 0,
    explanation:
      "SJF is mathematically optimal for minimizing the average time processes spend waiting.",
  },
  {
    ...
    correct: 1,
    explanation:
      "It is hard to predict exactly how long the next CPU burst will be before it happens.",
  },
  {
    ...
    correct: 2,
    explanation:
      "SRTF will interrupt the current process if a new process arrives with a shorter remaining time.",
  },
  {
    ...
    correct: 1,
    explanation:
      "Aging gradually increases the priority of processes that wait for a long time.",
  },
  {
    ...
    correct: 2,
    explanation:
      "If the quantum is longer than the process bursts, it simply runs processes in the order they arrived (First-Come, First-Served).",
  },
  {
    ...
    correct: 1,
    explanation:
      "If the quantum is too small, context switching overhead is too high; if too large, it becomes FCFS.",
  },
  {
    ...
    correct: 2,
    explanation:
      "Round Robin is better for interactive users because it ensures a quick response time.",
  },
  {
    ...
    correct: 1,
    explanation:
      "Processes can move up or down between queues based on their behavior (like CPU-bound vs I/O-bound).",
  },
  {
    ...
    correct: 1,
    explanation:
      "PCS means threads in the same process compete with each other for available 'lightweight process' resources.",
  },
  {
    ...
    correct: 1,
    explanation:
      "SCS means the thread competes against all other threads in the entire system.",
  },
  {
    ...
    correct: 1,
    explanation:
      "In many SMP systems, each CPU has its own private queue of processes ready to run.",
  },
  {
    ...
    correct: 1,
    explanation:
      "Running on the same CPU is more efficient because the CPU's cache might still contain the process's data.",
  },
  {
    ...
    correct: 2,
    explanation:
      "Overloaded CPUs can push tasks away, and idle CPUs can pull tasks from busy ones.",
  },
  {
    ...
    correct: 1,
    explanation:
      "Scheduling is needed in both single and multiprocessor systems to manage how tasks use the available CPU cores.",
  },
  {
    ...
    correct: 0,
    explanation:
      "A process spends its life moving between doing math/logic (CPU) and waiting for data (I/O).",
  },
  {
    ...
    correct: 1,
    explanation:
      "The short-term scheduler selects from the 'Ready Queue'; loading into memory is typically the job of a long-term scheduler.",
  },
  {
    ...
    correct: 0,
    explanation:
      "When a process finishes, it leaves the CPU voluntarily, making it a nonpreemptive scheduling point.",
  },
  {
    ...
    correct: 1,
    explanation:
      "The scheduler *selects* the process, while the dispatcher *gives control* of the CPU to that process.",
  },
  {
    ...
    correct: 0,
    explanation:
      "Turnaround time is the total time from submission to completion, which includes waiting and execution.",
  },
  {
    ...
    correct: 1,
    explanation:
      "First-Come, First-Served can be very slow (Convoy Effect); SJF is the one that minimizes waiting time.",
  },
  {
    ...
    correct: 0,
    explanation:
      "Mathematically, Shortest Job First is the best way to keep average wait times as low as possible.",
  },
  {
    ...
    correct: 0,
    explanation:
      "While it can vary by system, in general computing theory, 0 or 1 is usually the highest priority.",
  },
  {
    ...
    correct: 0,
    explanation:
      "It uses a timer (quantum) to force a process off the CPU so others can take a turn.",
  },
  {
    ...
    correct: 0,
    explanation:
      "If the CPU switches tasks too often, it spends more time 'switching' than actually doing work.",
  },
  {
    ...
    correct: 1,
    explanation:
      "In a standard Multilevel Queue, processes stay in their assigned queue. They only move in a 'Multilevel Feedback Queue'.",
  },
  {
    ...
    correct: 0,
    explanation:
      "The red-black tree helps Linux quickly find the task that has had the least amount of CPU time (vruntime).",
  },
  {
    ...
    correct: 1,
    explanation:
      "It usually means a *preference* (soft affinity) to stay on the same CPU, not a strict requirement.",
  },
  {
    ...
    correct: 1,
    explanation:
      "It uses both 'push' (moving tasks from busy CPUs) and 'pull' (idle CPUs taking tasks from busy ones).",
  },
];
