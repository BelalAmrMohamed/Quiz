export const questions = [
  {
    ...
    correct: 1,
    explanation:
      "Consistency implies no conflicts; it is possible for all requirements to be satisfied simultaneously.",
  },
  {
    ...
    correct: 1,
    explanation:
      "If no assignment makes them all true, the system is inconsistent.",
  },
  {
    q: "System specifications are consistent if:",
    options: [
    ...
    correct: 1,
    explanation:
      "Simultaneous satisfaction of all propositions is the definition of consistency.",
  },
  {
    ...
    correct: 0,
    explanation:
      "A tautology is true regardless of the truth values of its constituent variables.",
  },
  {
  ...
  },
  {
    ...
    correct: 1,
    explanation:
      "A contradiction is false for every possible combination of truth values.",
  },
  {
    q: "A compound proposition that is always false is a:",
    options: ["Tautology", "Contradiction", "Contingency", "Identity"],
    correct: 1,
  ...
  },
  {
    ...
    correct: 1,
    explanation:
      "This is Disjunctive Syllogism form. If (p or q) is true and p is false, q MUST be true. It's always valid.",
  },
  {
    ...
    correct: 0,
    explanation:
      "Satisfiable means it is NOT a contradiction; there is at least one 'solution'.",
  },
  {
    q: 'A compound proposition is "satisfiable" if:',
    options: [
  ...
  // Level 4: Logical Equivalences
  {
    q: "If a proposition is false for every assignment of truth values, it is:",
    options: ["Satisfiable", "Unsatisfiable", "A tautology", "A contingency"],
    correct: 1,
  ...
  },
  {
    ...
    correct: 1,
    explanation:
      "This is the second of De Morgan's laws: negation of OR is the AND of negations.",
  },
  {
  ...
  },
  {
    ...
    correct: 0,
    explanation:
      "ANDing with True leaves the original value unchanged (True if p is true, False if p is false).",
  },
  {
    q: "The Identity Law p ∧ T ≡:",
    options: ["p", "T", "F", "¬p"],
  ...
  },
  {
    ...
    correct: 1,
    explanation:
      "If one part of an OR is True, the whole statement is True regardless of p.",
  },
  {
    q: "The Domination Law p ∨ T ≡:",
    options: ["p", "T", "F", "q"],
  ...
  },
  {
    ...
    correct: 0,
    explanation:
      "The term (p AND q) is a subset of p; if p is true, the result is true. If p is false, both are false.",
  },
  {
  ...
  },
  {
    ...
    options: ["True", "False", "Only true if q is true", "A contradiction"],
    correct: 0,
    explanation:
      "This is the definition of implication in terms of OR and NOT.",
  },
  {
    q: "The logical equivalence p → q ≡ ¬p ∨ q is:",
    options: [
    ...
    correct: 0,
    explanation:
      "This equivalence allows us to rewrite implications without the arrow operator.",
  },
  {
    ...
    correct: 0,
    explanation:
      "For 'Every' (universal), we use implication. We only care about x IF x is a student.",
  },
  {
    ...
    correct: 0,
    explanation:
      "Using AND would imply that EVERY person in the universe is a student and studies Java, which is wrong.",
  },
  {
  ...
  },
  {
    ...
    correct: 0,
    explanation:
      "We assume m and n are rational (p), add them, and show the sum is rational (q).",
  },

  // Level 5: Predicates and Quantifiers
  {
    ...
    correct: 0,
    explanation:
      "P stands for Predicate (the property) and x is the subject variable.",
  },
  {
    q: "In the expression P(x), P is the:",
    options: ["Variable", "Predicate", "Domain", "Quantifier"],
    correct: 1,
  ...
  },
  {
    ...
    correct: 1,
    explanation:
      "Once x has a specific value (is bound), the statement can be evaluated as True or False.",
  },
  {
  ...
  },
  {
    ...
    options: ["For all", "There exists", "Exactly one", "None"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["For all", "There exists at least one", "Exactly one", "None"],
    correct: 1,
    explanation: "Also read as 'for some'.",
  },
  {
    q: "The Existential Quantifier (∃) means:",
    options: ["For every", "There exists at least one", "For all", "For none"],
    correct: 1,
  ...
  },
  {
    ...
    correct: 1,
    explanation:
      "Only one specific element in the domain satisfies the predicate.",
  },
  {
  ...
  },
  {
    ...
    correct: 1,
    explanation:
      "De Morgan's law for quantifiers: Negation passes through and flips the quantifier.",
  },
  {
    q: "The negation ¬∃xP(x) is equivalent to:",
    options: ["∀x¬P(x)", "∃x¬P(x)", "¬∀xP(x)", "∀xP(x)"],
    correct: 0,
    explanation:
      "To deny 'there exists one', you must say 'for all, it is not true'.",
  },
  {
    q: "The negation ¬∃xP(x) is logically equivalent to:",
    options: ["∀x¬P(x)", "∃x¬P(x)", "¬∀xP(x)", "∃xP(x)"],
  ...
  },
  {
    ...
    correct: 0,
    explanation:
      "Universal + Implication is the standard form for 'All X are Y'.",
  },
  {
    q: 'The statement "Every comedian is funny" is expressed as:',
    options: [
    ...
    correct: 0,
    explanation:
      "This construction filters the domain for comedians before checking if they are funny.",
  },
  {
    ...
    correct: 1,
    explanation:
      "Existential statements ('There is') usually use conjunction (AND) to identify the item and its property.",
  },
  {
    q: "The truth value of ∀x(x+1>x) over all real numbers is:",
    options: ["True", "False", "Counterexample exists", "Contingent"],
    correct: 0,
    explanation: "Adding 1 always increases the value, so this is always true.",
  },
  {
    q: "If the domain is positive integers, ∃x(x<2) is:",
    options: ["True (for x=1)", "False", "A tautology", "A contradiction"],
    correct: 0,
  ...
  },
  {
    ...
    correct: 0,
    explanation:
      "If both are universal, they can be swapped without changing meaning.",
  },
  {
    q: "In nested quantifiers, the order of ∀x∀y:",
    options: [
  ...
  },
  {
    ...
    options: ["∀y∀xP(x,y)", "∃x∃yP(x,y)", "∀x∃yP(x,y)", "¬∀x∀yP(x,y)"],
    correct: 0,
  ...
  },
  {
    ...
    correct: 1,
    explanation:
      "For any number x, there is a specific number y (its negative) that zeroes it out.",
  },
  {
  ...
  },
  {
    ...
    options: ["True (if x=0)", "False", "A contradiction", "A tautology"],
    correct: 0,
    explanation:
      "If x is 0, then 0 multiplied by ANY y is 0. So there exists such an x.",
  },

  // Level 6: Nested Quantifiers and Translation
  {
    ...
    correct: 2,
    explanation:
      "Swapping mixed quantifiers changes the meaning (e.g., 'Everyone loves someone' vs 'Someone is loved by everyone').",
  },
  {
    ...
    correct: 0,
    explanation:
      "For all x: (x has computer) OR (there exists y such that y has computer AND y is friend of x).",
  },
  {
    ...
    correct: 0,
    explanation:
      "If y and z are both friends of x (and distinct), then y and z are NOT friends.",
  },
  {
    q: "When negating the statement ∀x∃y(xy=1), the result is:",
    options: ["∃x∀y(xy=1)", "∀x∃y(xy≠1)", "∃x∀y(xy≠1)", "∃x∃y(xy≠1)"],
    correct: 2,
    explanation:
      "Negation flips ∀ to ∃, ∃ to ∀, and negates the equals to not-equals.",
  },
  {
    ...
    correct: 2,
    explanation:
      "Mixed quantifiers depend on the scope and order of selection.",
  },
  {
    ...
    correct: 0,
    explanation:
      "Quantifiers bind to the immediate predicate or parenthesized expression before other operators apply.",
  },
];
